...
const ViewProduct = () => {
  return (
    <LoadingOverlay active={isLoading} spinner text="Processing request ...">
      <Header />
      <div className="flex md:flex-row md:px-10 container mx-auto flex-shrink-0 px-4 lg:px-10 mt-5 w-100">
        ...
        <div className='feeds'>
            <div className={`${styles.card} md:ml-5 rounded-lg flex flex-col lg:flex-row bg-white shadow-md`}>
                <div className={styles.main_info}>
                    <div className={`${styles.card_header} rounded-tl-lg`}>
                    <div className={`${styles.label} bg-white w-28 rounded-br-lg flex flex-row items-center`}>
                    ...
                    <div className="p-6">
                    <h2 className="text-sm font-bold mb-2">LoftOS</h2>
                    <p className="text-gray-600 text-sm">
                        Innoloft the leading B2B tech ecosystem through interconnected
                        research & business networks and marketplaces. With our digital
                        platform technology, we are changing the way business contacts
                        are initiated between economic and innovation actors. Our unique
                        software-as-a-service (SaaS) solution LoftOS digitizes services
                        provided by governments and public economic agencies, clusters
                        and hubs, as well as event organizers and trade shows. Not only
                        can our LoftOS customers implement their digitization strategy
                        in a matter of months - each platform can also be connected
                        through our system and its data standard. Through this
                        connection, Innoloft and its partners are creating the largest
                        B2B tech ecosystem in the world.\nCompanies, startups, research
                        institutes and other business players use the ecosystem for lead
                        generation, innovation scouting, procurement or partner
                        acquisition.
                    </p>
                    </div>
                </div>
                <div className={`${styles.address} rounded-tr-lg md:w-40 p-4`}>
                    ...
                    <div className='flex flex-row w-3/4 gap-2 mt-5'>
                        ...
                        <img src='https://maps.googleapis.com/maps/api/staticmap?center=6.100367,50.779729&zoom=12&size=400x400&key=AIzaSyCu3hH5-wT8ks4sgUSquWCkODsNF8nIexQ' alt='map' />
                    </div>
                    </div>
                </div>
            </div>
            ...
            {/* Video content start */}
            <div className={`${styles.card} md:ml-5 rounded-lg flex flex-col bg-white shadow-md mt-8 p-5`}>
                <span className='text-sm'>
                    Video
                </span>
                <div className={styles.video}>
                    <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
                </div>
            </div>
        </div>
      </div>
