...
const NavBar: React.FC<({offer_title: string})> = ({offer_title}) => {
  return (
    ...
    <button className="bg-[#272E71] hover:bg-[#272E71] text-white font-bold px-2 py-1.5 rounded mb-4 text-xs"> Edit</button>
    </div>
  );
};
