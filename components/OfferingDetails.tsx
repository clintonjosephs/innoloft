...
import { stripTags } from '../helpers/formatter';
...
const OfferingDetails: React.FC<OfferingDetailsProps> = ({ data, staticMapUrl, edit, handleSubmit }) => {
  ...
  const dispatchFormUpdate = (value = '') => {
    dispatch(setformData({ description: editorState.getCurrentContent().getPlainText(), name: value }));
  }
      ...
      <div className={styles.main_info}>
        ...
        >
          <div className="flex flex-row justify-between">
            ...
            {edit ? (
              <div className="bg-white w-8 rounded-bl-lg flex flex-row justify-center items-center cursor-pointer">
                <Image
                  src="/assets/images/inno_delete.png"
                  width={16}
                  height={16}
                  alt="delete"
                />
        ...
        <div className="p-6">
          {edit ? (
            <>
              ...
              <div className="flex flex-row float-right mt-5">
                <button
                  type="button"
                  className="h-8 text-[#6B7280] bg-white hover:bg-white focus:ring-4 outline-none focus:ring-blue-300 rounded-lg text-sm px-3 py-1 mr-2 mb-2 border border-[#6B7280]"
                >
                  Cancel
                </button>
                ...
                <button
                  type="button"
                  className="h-8 text-white bg-[#515972] hover:bg-[#515972] outline-none focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-1 mr-2 mb-2 flex flex-row items-center"
                  onClick={handleSubmit}
                >
                  <Image src="/assets/images/check.png" className='mr-2' width={16} height={16} alt="save" />Save
                </button>
              </div>
            </>
          ) : (
      ...
      <div className={`${styles.address} rounded-tr-lg md:w-40 p-4`}>
        <div className="w-100">
          ...
          <Image
            ...
            className="my-4"
          />
          <UserProfile user={data.user} company_name={data.company.name} />
